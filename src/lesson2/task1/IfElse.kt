...
fun timeForHalfWay(t1: Double, v1: Double,
    ...
    if (halfWay <= s1 + s2) return (halfWay - s1) / v2 + t1
...
fun triangleKind(a: Double, b: Double, c: Double): Int {
    ...
    return when {
        maxSide >= notMax1 + notMax2 -> -1
        maxSide * maxSide == notMax1 * notMax1 + notMax2 * notMax2 -> 1
        maxSide * maxSide > notMax1 * notMax1 + notMax2 * notMax2 -> 2
        else -> 0
    }
}
